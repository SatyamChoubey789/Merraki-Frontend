        ...
        <Box>
          ...
          <ResponsiveContainer width="100%" height={260}>
            <ComposedChart data={r.forecast} margin={{ top: 8, right: 4, left: 0, bottom: 0 }}>
              ...
              <Bar dataKey="revenue" name="Revenue" fill={ACCENT + '40'} radius={[3,3,0,0]} barSize={28} />
              <Line type="monotone" dataKey="ebitda" name="EBITDA" stroke={ACCENT} strokeWidth={2} dot={{ fill: ACCENT, r: 4, strokeWidth: 0 }} />
            </ComposedChart>
          </ResponsiveContainer>
          ...
          <ResponsiveContainer width="100%" height={200}>
            <AreaChart data={r.forecast} margin={{ top: 8, right: 4, left: 0, bottom: 0 }}>
              ...
              <YAxis tickFormatter={v => fmtINR(v)} tick={axisStyle} tickLine={false} axisLine={false} width={76} />
              <Tooltip content={<ChartTooltip />} cursor={{ stroke: T.border, strokeWidth: 1 }} />
              <Area type="monotone" dataKey="pv" name="Present Value" stroke={ACCENT} strokeWidth={2} fill="url(#pvGrad)" dot={{ fill: ACCENT, r: 4, strokeWidth: 0 }} />
            </AreaChart>
          </ResponsiveContainer>
        </Box>
      }
