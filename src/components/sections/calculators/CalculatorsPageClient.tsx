      ...
      >
        ...
        <Container maxWidth="xl" sx={{ position: 'relative', zIndex: 1 }}>
          ...
          >
            ...
            <Typography
              variant="subtitle1"
              sx={{ color: 'rgba(255,255,255,0.55)', maxWidth: 520, lineHeight: 1.75 }}
            >
              ...
              <Tab
                ...
                label={
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.25, py: 0.5 }}>
                    <Box
                      sx={{
                        color: activeTab === i ? tab.color : 'rgba(255,255,255,0.45)',
                        display: 'flex',
                ...
                sx={{
                  ...
                  borderBottom: activeTab === i ? `1px solid ${colorTokens.white}` : undefined,
