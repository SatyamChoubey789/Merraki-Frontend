...
/* personality types */
const TYPES = [
  { label:'Strategic Visionary',  sub:'Long-term pattern recogniser', icon:'◈', accent:'#2563EB' },
  { label:'Analytical Optimizer', sub:'Data-driven decision maker',   icon:'◆', accent:'#7C3AED' },
  { label:'Growth Accelerator',   sub:'Revenue-first thinker',        icon:'△', accent:'#059669' },
  { label:'Cautious Builder',     sub:'Risk-aware operator',          icon:'○', accent:'#D97706' },
  { label:'Dynamic Innovator',    sub:'Creative capital deployer',    icon:'◇', accent:'#BE185D' },
];
    ...
    >
      ...
      >
        <Box sx={{
          ...
          <Typography sx={{ fontFamily:MONO, fontSize:'0.75rem', color:type.accent }}>
            {type.icon}
          </Typography>
  ...
  return (
    <motion.button
      ...
      style={{
        ...
        boxShadow: disabled
          ? 'none'
          : `0 8px 28px ${T.highlightGlow}`,
        transition:'all 0.2s ease',
      }}
    >
      <Typography sx={{ fontFamily:SANS, fontWeight:700, fontSize:'0.95rem' }}>
        Begin Assessment
      </Typography>
      ...
      <Box sx={{ display:'flex', flexDirection:{ xs:'column', md:'row' }, minHeight:'100vh' }}>
        ...
        <Box sx={{
          ...
          <Typography sx={{
            ...
            {isLoading ? 'Loading…' : `${totalQuestions} Questions · 5 Minutes · Free PDF`}
          </Typography>
        </Box>
