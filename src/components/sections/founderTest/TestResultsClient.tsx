...
import type {
  TestResult,
  PersonalityType,
} from "@/lib/hooks/useFounderTestEngine";
                  ...
                  <Box key={score.dimension}>
                    ...
                    >
                      <motion.div
                        ...
                        style={{
                          height: "100%",
                          background: `linear-gradient(90deg,${CHART_COLORS[i % CHART_COLORS.length]}70,${CHART_COLORS[i % CHART_COLORS.length]})`,
                          borderRadius: "3px",
                        }}
                      />
                    </Box>
        ...
        <Section delay={0.4}>
          ...
          >
            ...
            <Box sx={{ position: "relative", zIndex: 1, maxWidth: 560 }}>
              ...
              >
                Book a free 30-minute consultation and build a financial roadmap
              ...
              <Box sx={{ display: "flex", gap: 1.5, flexWrap: "wrap" }}>
                ...
                >
                  ...
                  >
                    <CalendlyIcon
                      sx={{ fontSize: "0.95rem", color: T.white }}
                    />
                    <Typography
                      sx={{
                        fontFamily: SANS,
                ...
                >
                  ...
                  >
                    <TemplatesIcon
                      sx={{ fontSize: "0.95rem", color: T.darkMuted }}
                    />
                    <Typography
                      sx={{
                        fontFamily: SANS,
