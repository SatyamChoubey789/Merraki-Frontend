    ...
    <Box sx={{ display: "flex", flexDirection: "column", gap: 0.75 }}>
      ...
      <Box
        ...
        sx={{
          ...
          "&:focus": {
            borderColor: error ? T.error : T.borderMd,
            boxShadow: error
              ? `0 0 0 3px rgba(220,38,38,0.08)`
              : `0 0 0 3px rgba(12,14,18,0.06)`,
          },
      ...
      {helperText && (
        <Typography
          sx={{
            fontFamily: SANS,
            fontSize: "0.75rem",
            color: error ? T.error : T.inkGhost,
            lineHeight: 1.4,
          }}
        >
          {helperText}
          ...
          <Box sx={{ width: "100%", maxWidth: 480 }}>
            ...
            >
              ...
              <Box sx={{ mb: 4 }}>
                ...
                >
                  Your detailed PDF report will be emailed instantly. No spam,
                  ever.
                </Typography>
              </Box>
              ...
              >
                ...
                >
                  ...
                  >
                    Your data stays private. No selling, no spam, unsubscribe
                    anytime.
                  </Typography>
                </Box>
                  ...
                  <motion.button
                    ...
                    style={{
                      ...
                      boxShadow: isSubmitting
                        ? "none"
                        : "0 5px 20px rgba(59,130,246,0.26)",
